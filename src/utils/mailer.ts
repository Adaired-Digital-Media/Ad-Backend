                ...
                <tbody>
                  <tr>
                    <td align="left" style="margin: 0; padding-bottom: 15px; padding-top: 20px; padding-left: 20px; padding-right: 20px;">
                      <h2 style="margin: 0; line-height: 36px; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: normal; color: #333333;"><strong>${type === "order" ? "Order" : "Invoice"} Details</strong></h2>
                    </td>
                  </tr>
                  <tr>
                        ...
                        <tbody>
                          <tr>
                            <td align="left" valign="top" width="50%" style="margin: 0; padding-right: 5px; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; border: 0;">
                              <span style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #666666; font-size: 18px; font-weight: 500;">${type === "order" ? "Order" : "Invoice"} Number</span>
                            </td>
                    ...
                    <td style="padding: 0; margin: 0;">
                      <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="border-collapse: collapse; border-spacing: 0px;">
                        <tbody>
                          <tr>
                            <td align="left" valign="top" width="50%" style="margin: 0; padding-right: 5px; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; border: 0;">
                              <span style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #666666; font-size: 18px; font-weight: 500;">${type === "order" ? "Order" : "Issued"} Date</span>
                            </td>
                            <td align="right" valign="top" width="50%" style="margin: 0; padding-left: 5px; padding-top: 10px; padding-bottom: 10px; padding-right: 20px; border: 0;">
...
export const sendInvoiceGeneratedEmail = async (
  ...
  try {
    const invoice = await Invoice.findById(invoiceId).populate("userId").populate("orderId");
    if (!invoice || !invoice.userId || !invoice.orderId) throw new Error("Invoice, user, or order not found");
...
//     const mailOptions = {
//       from: `"Adaired" <${process.env.EMAIL_USERNAME}>`,
//       to,
//       subject,
//       html,
//     };
...
//                   <tr>
//                     <td align="left" style="margin: 0; padding-bottom: 15px; padding-top: 20px; padding-left: 20px; padding-right: 20px;">
//                       <h2 style="margin: 0; line-height: 36px; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: normal; color: #333333;"><strong>Order Details</strong></h2>
//                     </td>
//                   </tr>
//                   <tr>
//                     <td align="center" style="padding: 0; margin: 0; padding-top: 5px; padding-bottom: 5px; font-size: 0;">
...
//                           <tr>
//                             <td align="left" valign="top" width="50%" style="margin: 0; padding-right: 5px; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; border: 0;">
//                               <span style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #666666; font-size: 18px; font-weight: 500;">Order Number</span>
//                             </td>
//                             <td align="right" valign="top" width="50%" style="margin: 0; padding-left: 5px; padding-top: 10px; padding-bottom: 10px; padding-right: 20px; border: 0;">
//                               <span style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333333; font-size: 18px; font-weight: 600;">${orderNumber}</span>
//                             </td>
//                           </tr>
//                         </tbody>
//                       </table>
...
//                           <tr>
//                             <td align="left" valign="top" width="50%" style="margin: 0; padding-right: 5px; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; border: 0;">
//                               <span style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #666666; font-size: 18px; font-weight: 500;">Order Date</span>
//                             </td>
//                             <td align="right" valign="top" width="50%" style="margin: 0; padding-left: 5px; padding-top: 10px; padding-bottom: 10px; padding-right: 20px; border: 0;">
//                               <span style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333333; font-size: 18px; font-weight: 600;">${orderDate}</span>
//                             </td>
//                           </tr>
//                         </tbody>
//                       </table>
...
//                 <a href="${linkUrl}" style="display: inline-block; background-color: #FB9100; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 25px; font-size: 16px; font-weight: 600; box-shadow: 0 3px 6px rgba(0, 0, 0, 0.1);">${linkText}</a>
//               </div>
//               <p style="font-size: 16px; line-height: 1.6; margin: 0; color: #000000; text-align: center;">Best Regards,<br>Team Adaired</p>
//             </td>
//           </tr>
//           <tr>
//             <td style="background: linear-gradient(135deg, #000000, #1B5A96); padding: 20px; text-align: center; color: #ffffff;">
...
//       paymentStatus === "Unpaid"
//         ? order.paymentUrl
//         : `${process.env.BHW_DASHBOARD_URI}/orders/${order.orderNumber}`;
//     const linkText = paymentStatus === "Unpaid" ? "Pay Now" : "View Order";
//     const closing = `Best Regards,<br>Team Adaired`;
...
//       closing
//     );
//     await sendEmail(user.email, `${subject} - Order #${orderNumber}`, html);
//   } catch (error) {
//     console.error("Failed to send order confirmation email:", error);
//   }
// };
...
//     const totalAmount = `$${order.finalPrice.toFixed(2)}`;
//     const paymentStatus = order.paymentStatus;
//     const linkUrl = `${process.env.BHW_DASHBOARD_URI}/orders/${order.orderNumber}`;
//     const linkText = "View Order";
//     const closing = `Best Regards,<br>Team Adaired`;
...
//     await Promise.all(
//       adminEmails.map((email) =>
//         sendEmail(email, `${subject} - Order #${orderNumber}`, html)
//       )
//     );
//   } catch (error) {
//     console.error("Failed to send admin new order email:", error);
...
//     const totalAmount = `$${invoice.finalAmount.toFixed(2)}`;
//     const paymentStatus = invoice.status;
//     const linkUrl = `${process.env.BHW_DASHBOARD_URI}/invoices/${invoice.invoiceNumber}`;
//     const linkText = "View Invoice";
//     const closing = `Best Regards,<br>Team Adaired`;
...
//     const totalAmount = `$${invoice.finalAmount.toFixed(2)}`;
//     const paymentStatus = invoice.status;
//     const linkUrl = `${process.env.ADMIN_DASHBOARD_BASE_URI}/invoices/invoice-details?invoiceNumber=${invoice.invoiceNumber}`;
//     const linkText = "View Invoice";
//     const closing = `Best Regards,<br>Team Adaired`;
